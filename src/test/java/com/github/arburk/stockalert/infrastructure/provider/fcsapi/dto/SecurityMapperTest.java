...
class SecurityMapperTest {
  ...
  void mappingTestHappyFlow() {
    ...
    assertEquals("Security[symbol=DVN, price=31.94, currency=USD, changePercentage=-0.0062, timestamp=2025-08-04T19:59:59, exchange=NYSE, alertLog=null]", output.toString());
  }
