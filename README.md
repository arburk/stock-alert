...
| SUMMARY-FILE                 | location where to write a summary file of recent perfomed run as markdown file (e.g. ./execution_summary.md)                                                                                                                                          | n/a                           |
...
- 1.1.0 - summarize recent execution as markdown file, removed deprecated former file format 
